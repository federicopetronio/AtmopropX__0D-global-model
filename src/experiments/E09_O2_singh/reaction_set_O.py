...
def get_species_and_reactions(chamber):
    ...
    species = Species([Specie("e", m_e, -e, 0, 3/2), Specie("O2", 5.31e-26, 0, 2, 7/2), Specie("O", 2.67e-26, 0, 1, 3/2), Specie("O2+", 5.31e-26, e, 2, 7/2), Specie("O+", 2.67e-26, e, 1, 3/2)])
...
#   █  █ █ █▄▄ █▀▄ █ ▀ █ █ ▀▄▄   █▄▀ █ █▀ █▀ ▀▄█ ▄██ █ ▀▄▀ █ ▀█  
    ...
    kappa["O2"] = lambda T_i : 1.75*1.66e-4 * (e/k_B * T_i)**0.798 #1.66e-5 * (e/k_B * T_i)**0.798    #kappa = lambda T_i : 0.0
...
#  ██▀ █   ██▀ ▄▀▀ ▀█▀ █▀▄ ▄▀▄ █▄ █   █▄█ ██▀ ▄▀▄ ▀█▀ █ █▄ █ ▄▀    ██▄ ▀▄▀   ▀█▀ █▄█ ██▀   ▄▀▀ ▄▀▄ █ █    
#  █▄▄ █▄▄ █▄▄ ▀▄▄  █  █▀▄ ▀▄▀ █ ▀█   █ █ █▄▄ █▀█  █  █ █ ▀█ ▀▄█   █▄█  █     █  █ █ █▄▄   ▀▄▄ ▀▄▀ █ █▄▄  
    electron_heating = ElectronHeatingConstantRFPower(species, chamber.target_power, chamber)
    print("Electron heating power set to ", chamber.target_power, " W")

    def identity(t, state, dy):
        return dy

    return species, initial_state, reaction_list, electron_heating, identity